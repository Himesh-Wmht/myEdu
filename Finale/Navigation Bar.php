   ...
   <body>
     <?php 
      ...
      <nav>
         ...
         <div class="logo">
         <img src="logo3.png" style= height="120px" width="150px"> 
         </div>
         ...
         <ul>
            ...
            <li>
               ...
               <ul style="margin-top: 0px;">
				 ...
				 <li>
                     <label for="btn-3" class="show" >Sports</label>
                     <a href="#">Sports <span class="fa fa-plus"></span></a>
                     <input type="checkbox" id="btn-3" class="nb">
                     <ul>
                        <li><a href="equipments.php">Cricket</a></li>
                        <li><a href="equipments.php?indoor.php">IndoorGames</a></li>
                        <li><a href="equipments.php">Athletics</a></li>
                     </ul>
                  </li>
               </ul>
            </li>
