     ...
     <?php 
      ...
      <nav>
         ...
         <img src="MY-EDU.png" style= height="120px" width="150px"> 
		  ...
		  <div class="logo" style=" color: white" align="left"  >
         ...
         <ul>
            ...
            <li>
               <label for="btn-2" class="show">NEWS</label>
               <a href="#">Services</a>
               <input type="checkbox" id="btn-2" class="nb">
               <ul style="margin-top: 0px;">
               
				 <li>
                     <label for="btn-3" class="show" >INFORMATIONS</label>
                     <a href="#">INFORMATIONS <span class="fa fa-plus"></span></a>
                     <input type="checkbox" id="btn-3" class="nb">
                     <ul>
                        <li><a href="equipments.php?tabIndex=1">RESULTS</a></li>
                        <li><a href="equipments.php?tabIndex=2">SCHEDULES</a></li>
                        <li><a href="equipments.php?tabIndex=3">FEEDBACK</a></li>
            ...
            <li><a href="cusdetails.php">ACHIEVEMENT</a></li>
		...
		<a href="LogoutUs.php" style="font-size: 22px";"margin-right:50px;" onClick="return confirm('Are you sure you want to logout');"> <i class="fas fa-power-off"></i></a></li>
